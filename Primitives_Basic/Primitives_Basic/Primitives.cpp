...
PrimitiveApp::PrimitiveApp(HINSTANCE hInstance) : D3DApp(hInstance), mBoxVB(0), mBoxIB(0), mFX(0), mTech(0),
mfxWorldViewProj(0), mInputLayout(0),
mTheta(1.5f*MathHelper::Pi), mPhi(0.25f*MathHelper::Pi), mRadius(5.0f)
{
	mMainWndCaption = L"Primitives Basic";
...
void PrimitiveApp::UpdateScene(float dt)
{
...
void PrimitiveApp::BuildGeometryBuffers()
{
	//all vertices
	Vertex vertices[] =
	{
		{ XMFLOAT3(-1.0f, 0.0f, -1.0f), (const float*)&Colors::White }, //0
		{ XMFLOAT3(+1.0f, 0.0f, -1.0f), (const float*)&Colors::Green }, //1
		{ XMFLOAT3(-1.0f, 0.0f, +1.0f), (const float*)&Colors::Blue }, //2
		{ XMFLOAT3(+1.0f, 0.0f, +1.0f), (const float*)&Colors::Magenta }, //3
		{ XMFLOAT3(0.0f, +1.0f, 0.0f), (const float*)&Colors::Red }, //4
		{ XMFLOAT3(0.0f, -1.0f, +0.0f), (const float*)&Colors::Red }, //5
	};
...
void PrimitiveApp::BuildVertexLayout()
{
